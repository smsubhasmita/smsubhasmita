                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 		 
                                ...
                                <div class="form-group res-mg-t-15">
                                    ...
                                    <input name="phone" type="text" class="form-control  phone" id="phone" placeholder="999****999"   minlength="10" maxlength="12" size="10">
                                ...
                                <label for="type">Gramapachayat</label>
                                    <select class="form-control" id="gp_id" name="gp_id"> 
                                        <option value="" >Select Gramapachayat</option>
                                        
                                    </select>
                                </div>
                                <div class="form-group res-mg-t-15">
                                    <label for="type">Address</label>
                                    <input name="address" type="text" id="address" class="form-control username" placeholder="Address" >
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12"> 
                                <div class="form-group res-mg-t-15">
                                    ...
                                    <input name="reg_num" type="text" class="form-control reg_num" placeholder="User  Name" >
                                    <span id="reg_num"></span>
                                </div>
                            
                                <div class="form-group res-mg-t-15">
                                    <label for="type">Email</label>
                                    <input name="email" type="email"id="email" class="form-control username" placeholder="example@gmail.com">
                                    <span id="email_id"></span>
                                    <!-- <div class="alert alert-success mt-2" role="alert" style="display:<?php echo ($msg !='')?'':'none';?> ">
                                    <?php echo isset($msg)?$msg:'';?>
                                    </div>
                                    <div class="alert alert-danger mt-2" role="alert" style="display:<?php echo ($error !='')?'':'none';?> ">
                                ...
                                <div class="form-group res-mg-t-15">
                                    ...
                                    <input name="pin" type="text" class="form-control username" id="pin" placeholder="Pincode" value="">
                                </div> 
                            </div>   
                        </div>
